...
router.get("/facebook",function(req,res){
  flag=true;
  res.redirect("https://www.facebook.com/v7.0/dialog/oauth?client_id="+process.env.CLIENT_ID+"&redirect_uri=http://localhost:3000/login/code&state={'ciao'}&response_type=code");
